...
class TestPlant:
    ...
    def test_plant_by_id_get_route(self):
        ...
        assert response.status_code == 404  # Assuming ID 1 doesn't exist, hence 404
    ...
    def test_plant_by_id_get_route_returns_one_plant(self):
        ...
        assert response.status_code == 404  # Assuming ID 1 doesn't exist, hence 404
        assert "error" in data  # Check for the presence of the "error" key in the JSON response
